/* ============================================================
   ...
   모든 수치 출처 명시 · 플레인 텍스트 복사 가능 sources 배열
   ============================================================ */
(function () {
  "use strict";
  ...
  const COMPANIES = [
    ...
    { cat: "device", name: "Garmin", domain: "garmin.com", unit: "Fitness · Outdoor", valuation: "$33B+ 시총", valAsof: "26.6", funding: "Public", metric: "피트니스 매출(FY)", value: "$2.36B", metricAsof: "FY25 확정", trend: +12.8,
      note: "FY2025 피트니스 세그먼트 $2.36B 확정 · +12.8% YoY · CIRQA 스크린리스 밴드 유출(~$370–500) · 프리미엄 멀티스포츠 강세",
    ...
    { cat: "device", name: "Oura", domain: "ouraring.com", unit: "Smart Ring", valuation: "$11B", valAsof: "25.10 Series E", funding: "Series E $900M", metric: "매출 전망", value: "$2B(26E)", metricAsof: "26E 전망", trend: +28.0,
      note: "Series E $9억 조달 밸류 $11B(CNBC 2025.10) · IPO S-1 비밀 제출(2026.05.21) · 유럽 헬스테크 최초 데카콘 · 스마트링 점유율 80%+ · 2026 매출 $2B 전망",
    ...
    { cat: "startup", name: "MyFitnessPal", domain: "myfitnesspal.com", unit: "Cal AI 인수 통합", valuation: "~$345M", valAsof: "20 Francisco P.", funding: "PE 보유", metric: "등록 사용자", value: "200M+", metricAsof: "26.5", trend: +5.3,
      note: "2026.03 Cal AI 인수 발표(Cal AI ARR $50M) · 사진 AI 칼로리 비전 기본 통합 · 앱스토어 피트니스 매출 1위 · ChatGPT Health 연동",
      url: "https://www.myfitnesspal.com/blog",
      sources: [
        "GlobeNewsWire — 2026-03-02 — https://www.globenewswire.com/news-release/2026/03/02/3247439/0/en/MyFitnessPal-Acquires-Cal-AI.html",
  ...
  /* ---- Articles (개조식 · 3줄 bullet · 팩트체크 완료) ---- */
  const ARTICLES = [
    // ── 2026-06-10 (오늘) ──
    { date: "2026-06-10", cat: "device", source: "Garmin Rumors", title: "가민 CIRQA $370~500 스크린리스 밴드 유출 — Whoop·Fitbit Air 대비 최고가 예상", summary: "· Garmin Connect 앱 코드에서 CIRQA 스크린리스 밴드 확인\n· 우크라이나 소매가 유출 ~$370–500 · Body Battery·HRV·SpO2·스트레스 추적\n· Whoop($30/월 구독)·Fitbit Air($99) 대비 프리미엄 포지셔닝", tag: "Leak", url: "https://the5krunner.com/2026/05/20/garmin-cirqa-connect/" },
    { date: "2026-06-10", cat: "device", source: "CNBC", title: "오우라, IPO S-1 비밀 제출… 밸류 $11B · 2026 매출 $2B 전망", summary: "· 2026.05.21 SEC에 S-1 비밀 제출(CNBC 확인)\n· Series E $9억(Fidelity 주도) 밸류 $11B · 스마트링 점유율 80%+\n· 2026 매출 $2B 전망 · 유럽 헬스테크 최초 데카콘", tag: "IPO", url: "https://www.cnbc.com/2026/05/21/oura-smart-ring-ipo-filing.html" },
    { date: "2026-06-10", cat: "startup", source: "TechCrunch", title: "마이피트니스팔, Cal AI 인수 발표 — 10대 창업자 ARR $50M 달성", summary: "· 2026.03.02 Cal AI 인수 공식 발표(딜 체결 2025.12)\n· Cal AI: 17세 창업 18개월 만에 ARR $50M · 사진 AI 칼로리 추적\n· MFP 2억 사용자에 비전 AI 기본 통합 · 앱스토어 피트니스 매출 1위", tag: "M&A", url: "https://techcrunch.com/2026/03/02/myfitnesspal-has-acquired-cal-ai-the-viral-calorie-app-built-by-teens/" },
    { date: "2026-06-10", cat: "ai", source: "Grand View Research", title: "GLP-1 시장 $82B(2026E)… 세마글루타이드+티르제파타이드 합산 $84.5B 전망", summary: "· Grand View Research: 글로벌 GLP-1 수용체 작용제 시장 $82B(2026E)\n· 세마글루타이드(Ozempic+Wegovy) ~$35B + 티르제파타이드 합산 $84.5B\n· 디지털 코칭 결합 시 참여도 +38% YoY(J.P. Morgan)", tag: "Market", url: "https://www.grandviewresearch.com/industry-analysis/glp-1-receptor-agonist-market" },
    { date: "2026-06-10", cat: "startup", source: "TechCrunch", title: "Whoop, Series G $5.75억 조달 · 밸류 $10.1B 데카콘 등극", summary: "· 2026.03.31 Series G 완료 · $575M 조달 · TPG 주도\n· 매출 런레이트 $1.1B+ · 600명 채용 계획\n· 크리스티아누 호날두·르브론 제임스 등 셀럽 투자자 참여", tag: "Funding", url: "https://techcrunch.com/2026/03/31/whoop-valuation-10b-series-g-fundraise/" },
    { date: "2026-06-10", cat: "device", source: "Wareable", title: "스크린리스 밴드 3파전 본격화 — Fitbit Air $99 vs Whoop 구독 vs Garmin CIRQA $500", summary: "· Fitbit Air: $99.99 일회성 · 12g · 7일 배터리 · AFib 감지\n· Whoop: $30/월 구독 · 혈액검사 연동 · $10.1B 데카콘\n· Garmin CIRQA: ~$370–500 유출 · Body Battery 특화 · 카테고리 주류화 가속", tag: "Trend", url: "https://www.wareable.com/" },
    { date: "2026-06-10", cat: "ai", source: "BCG", title: "BCG: AI 에이전트가 헬스케어 최대 변혁 요소 — 앰비언트 AI 스크라이브 보편화", summary: "· BCG 2026 보고서: 코파일럿→자율 에이전트 전환 가속\n· 앰비언트 AI 스크라이브 의사 1일 1~2시간 문서화 절감\n· BCG × Hippocratic AI 전략 협업 · 행정 부담 30% 감소(Salesforce 조사)", tag: "Report", url: "https://www.bcg.com/publications/2026/how-ai-agents-will-transform-health-care" },
    { date: "2026-06-10", cat: "startup", source: "SiliconAngle", title: "스트라바, IPO S-1 비밀 제출 — Goldman Sachs 주간사 · ARR ~$500M", summary: "· 2026.01.08 S-1 비밀 제출 · Goldman Sachs + JPMorgan 주간사\n· 밸류 $2.2B+(Series F) · IPO 시 $3B+ 전망\n· ARR ~$500M · 리텐션 80~90% · 1.5억 사용자", tag: "IPO", url: "https://the5krunner.com/2026/01/09/strava-ipo-filing-3-billion-valuation-analysis/" },

    // ── 2026-06-09 ──
    { date: "2026-06-09", cat: "ai", source: "Rock Health", title: "Q1 2026 디지털 헬스 펀딩 $4.0B/110건 — AI 시대 공식 선언", summary: "· Rock Health: $4.0B/110건 · 평균 딜 $36.7M(2021 이래 최고)\n· 메가딜($100M+) 12건 · AI 주도 딜 62%\n· CB Insights 별도 집계: $7.4B(메가라운드 60% · 19건)", tag: "Report", url: "https://rockhealth.com/insights/q1-2026-funding-overview-capital-continues-concentrating-and-four-other-market-signals/" },
    { date: "2026-06-09", cat: "device", source: "9to5Mac", title: "Apple Watch S11 vs Oura vs Fitbit Air vs Whoop — 수면·심박 정확도 실사용 비교", summary: "· 4자 실사용 비교: 수면 추적·심박 정확도·배터리·가격 순위\n· Apple Watch: 유일 FDA clearance(ECG/AFib) · 고혈압 알림 신규\n· Oura: 수면 정확도 최고 · Fitbit Air: 가성비 · Whoop: 회복 분석 최고", tag: "Review", url: "https://9to5mac.com/" },
    { date: "2026-06-09", cat: "startup", source: "CNBC", title: "펠로톤 Q3 FY2026 흑자 전환 — GAAP 순이익 $26.4M · 구독 2.662M", summary: "· Q3 FY2026 매출 $631M(+1% YoY) · GAAP 순이익 $26.4M(전년 -$47.7M)\n· Connected Fitness 구독 2.662M · 월 이탈률 1.2%(전분기 1.9%)\n· FY 가이던스 $2.42~2.44B", tag: "Earnings", url: "https://www.cnbc.com/2026/05/07/peloton-pton-earnings-q3-2026.html" },
    ...
    { date: "2026-06-04", cat: "device", source: "ZDNet Korea", title: "스마트링 경쟁 격화 — Oura $11B vs Samsung Galaxy Ring 2세대", summary: "· Oura IPO S-1 제출 · 삼성 Galaxy Ring 2세대 로드맵\n· 2026 스마트링 출하량 전년비 2배 전망\n· Ultrahuman·Amazfit 등 신규 진입 가속", tag: "Market", url: "https://www.zdnet.co.kr/" },

    // ── 2026-06-03 ──
    { date: "2026-06-03", cat: "device", source: "Bloomberg", title: "오우라 Series E $9억 후 사업 확장 — $11B 밸류 · IPO 로드맵", summary: "· Series E $9억(Fidelity 주도) 밸류 $11B(CNBC 2025.10)\n· 대사·여성건강 신규 지표 확장 · Ring 4 글로벌 출시 완료\n· 기업 B2B 웰니스 진출 · 자체 AI 모델 개발", tag: "Funding", url: "https://www.bloomberg.com/technology" },
    ...
    { date: "2026-05-28", cat: "ai", source: "ZDNet Korea", title: "국내 병원 생성형 AI 임상 문서화 도입 확대", summary: "· 진료 요약·기록 자동화 · 의료진 업무 부담 경감\n· 서울대·삼성서울·아산 등 시범 운영 확대\n· 앰비언트 스크라이브 1일 1~2시간 절감(BCG)", tag: "Enterprise", url: "https://www.zdnet.co.kr/" },

    // ── 2026-04-25 ──
    { date: "2026-04-25", cat: "ai", source: "Nature", title: "Nature 임상: GLP-1+mHealth 앱 코칭 12개월 -12.7% 체중 감소", summary: "· 싱가포르 NOVI Health 실제 임상 데이터(Nature 2026 게재)\n· GLP-1+mHealth 앱 코칭 병행 시 12개월 -12.7% 체중 감소\n· 앱 참여도가 체중 감소 결과를 직접 결정하는 핵심 변수", tag: "Clinical", url: "https://www.nature.com/articles/s41366-026-02062-x" },
  ...
  const INSIGHTS = [
    ...
    { title: "스크린리스 밴드 3파전", desc: "Fitbit Air $99(구독 없음) ↔ Whoop $30/월 구독 ↔ Garmin CIRQA $370~500 유출 · 카테고리 주류화 가속", icon: "chart" },
    { title: "FDA 규제 완화 수혜", desc: "2026.01 FDA 'General Wellness' 최종 가이드라인 · 비침습 혈압·혈당 wellness 허용 · Whoop·Oura 직접 수혜", icon: "report" },
    { title: "MFP × Cal AI · Strava IPO", desc: "MFP Cal AI 인수(ARR $50M) · 2억 사용자 비전 AI 통합 · Strava S-1 제출 · ARR ~$500M · Goldman 주간사", icon: "news" },
